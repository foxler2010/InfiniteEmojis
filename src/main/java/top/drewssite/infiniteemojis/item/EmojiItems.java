...
public class EmojiItems {
   ...
   */
  public static final DeferredRegister<Item> EMOJI_ITEMS = DeferredRegister.create(
   ...
   */
  public static final RegistryObject<Item> GRINNING_FACE = EMOJI_ITEMS.register(
      "grinning_face",
      () -> new GrinningFaceItem(new Item.Properties()));

  public static final RegistryObject<Item> GRINNING_FACE_WITH_BIG_EYES = EMOJI_ITEMS.register(
      "grinning_face_with_big_eyes",
      () -> new GrinningFaceWithBigEyesItem(new Item.Properties()));

  public static final RegistryObject<Item> GRINNING_FACE_WITH_SMILING_EYES = EMOJI_ITEMS.register(
      "grinning_face_with_smiling_eyes",
      () -> new GrinningFaceWithSmilingEyesItem(new Item.Properties()));

  // Emojipedia Name: Beaming Face with Smiling Eyes
  public static final RegistryObject<Item> BEAMING_FACE = EMOJI_ITEMS.register(
      "beaming_face",
      () -> new BeamingFaceItem(new Item.Properties()));

  public static final RegistryObject<Item> GRINNING_SQUINTING_FACE = EMOJI_ITEMS.register(
      "grinning_squinting_face",
      () -> new GrinningSquintingFaceItem(new Item.Properties()));

  public static final RegistryObject<Item> SLIGHTLY_SMILING_FACE = EMOJI_ITEMS.register(
  ...
  public static final RegistryObject<Item> SMILING_FACE_WITH_SMILING_EYES = EMOJI_ITEMS.register(
      "smiling_face_with_smiling_eyes",
      () -> new SmilingFaceWithSmilingEyesItem(new Item.Properties()));

  // Emojipedia Name: Smiling Face with Heart Eyes
  public static final RegistryObject<Item> HEART_EYED_FACE = EMOJI_ITEMS.register(
      "heart_eyed_face",
      () -> new HeartEyedFaceItem(new Item.Properties()));

  // Emojipedia Name: Star-Struck
  public static final RegistryObject<Item> STAR_STRUCK_FACE = EMOJI_ITEMS.register(
      "star_struck_face",
      () -> new StarStruckFaceItem(new Item.Properties()));

  public static final RegistryObject<Item> FACE_BLOWING_A_KISS = EMOJI_ITEMS.register(
      "face_blowing_a_kiss",
      () -> new FaceBlowingAKissItem(new Item.Properties()));

  public static final RegistryObject<Item> KISSING_FACE = EMOJI_ITEMS.register(
      "kissing_face",
      () -> new KissingFaceItem(new Item.Properties()));

  // Emojipedia Name: Smiling Face
  public static final RegistryObject<Item> SMILING_FACE_WITH_CLOSED_EYES = EMOJI_ITEMS.register(
      "smiling_face_with_closed_eyes",
      () -> new SmilingFaceWithClosedEyesItem(new Item.Properties()));

  public static final RegistryObject<Item> KISSING_FACE_WITH_CLOSED_EYES = EMOJI_ITEMS.register(
      "kissing_face_with_closed_eyes",
      () -> new KissingFaceWithClosedEyesItem(new Item.Properties()));

  public static final RegistryObject<Item> KISSING_FACE_WITH_SMILING_EYES = EMOJI_ITEMS.register(
      "kissing_face_with_smiling_eyes",
      () -> new KissingFaceWithSmilingEyesItem(new Item.Properties()));

  public static final RegistryObject<Item> SMIRKING_FACE = EMOJI_ITEMS.register(
      "smirking_face",
