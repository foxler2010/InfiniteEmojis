 ...
 */
public class GrinningSquintingFaceItem extends Item {
   ...
   */
  public GrinningSquintingFaceItem(Properties properties) {
  ...
  public void appendHoverText(
    ...
    tooltipComponents.add(
        Component.literal("- ").append(
            Component.translatable("item.infiniteemojis.squinting_eyes"))
            .withStyle(ChatFormatting.GRAY));
