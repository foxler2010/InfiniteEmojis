 ...
 */
public class SmilingFaceWithClosedEyesItem extends Item {
   ...
   */
  public SmilingFaceWithClosedEyesItem(Properties properties) {
  ...
  public void appendHoverText(
    ...
    tooltipComponents.add(
        Component.literal("- ").append(
            Component.translatable("item.infiniteemojis.closed_eyes"))
            .withStyle(ChatFormatting.GRAY));
