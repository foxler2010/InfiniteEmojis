 ...
 */
public class GrinningFaceWithSmilingEyesItem extends Item {
   ...
   */
  public GrinningFaceWithSmilingEyesItem(Properties properties) {
  ...
  public void appendHoverText(
    ...
    tooltipComponents.add(
            Component.literal("- ").append(
                            Component.translatable("item.infiniteemojis.smile"))
                    .withStyle(ChatFormatting.GRAY));
