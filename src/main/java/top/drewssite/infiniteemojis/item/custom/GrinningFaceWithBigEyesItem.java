 ...
 */
public class GrinningFaceWithBigEyesItem extends Item {
   ...
   */
  public GrinningFaceWithBigEyesItem(Properties properties) {
  ...
  public void appendHoverText(
    ...
    tooltipComponents.add(
        Component.literal("- ").append(
            Component.translatable("item.infiniteemojis.big_eyes"))
            .withStyle(ChatFormatting.GRAY));
