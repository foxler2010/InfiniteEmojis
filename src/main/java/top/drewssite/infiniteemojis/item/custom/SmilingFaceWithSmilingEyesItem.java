 ...
 */
public class SmilingFaceWithSmilingEyesItem extends Item {
   ...
   */
  public SmilingFaceWithSmilingEyesItem(Properties properties) {
    super(properties);
  }
  ...
  public void appendHoverText(
    ...
    tooltipComponents.add(
        Component.literal("- ").append(
            Component.translatable("item.infiniteemojis.smiling_eyes"))
            .withStyle(ChatFormatting.GRAY));

    tooltipComponents.add(
        Component.literal("- ").append(
            Component.translatable("item.infiniteemojis.slight_smile"))
            .withStyle(ChatFormatting.GRAY));
