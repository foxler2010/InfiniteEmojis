 ...
 */
public class SmirkingFaceItem extends Item {
   ...
   */
  public SmirkingFaceItem(Properties properties) {
    super(properties);
  }
  ...
  public void appendHoverText(
    ...
    tooltipComponents.add(
            Component.literal("- ").append(
                            Component.translatable("item.infiniteemojis.smirking_eyes"))
                    .withStyle(ChatFormatting.GRAY));

    tooltipComponents.add(
            Component.literal("- ").append(
                            Component.translatable("item.infiniteemojis.smirking_mouth"))
                    .withStyle(ChatFormatting.GRAY));
